...
class LiveView(QWidget):
    ...
    def init_ui(self):
        ...
        # ✅ NEW: buttons to launch plugin windows
        self.logs_btn = QPushButton("Plugin Logs")
        self.status_btn = QPushButton("Plugin Status")
    ...
    def set_camera_manager(self, manager):
        ...
        self.refresh_camera_grid()
        QTimer.singleShot(100, self.init_threads)
